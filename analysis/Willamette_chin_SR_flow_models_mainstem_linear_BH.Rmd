...
write.csv(tbl_WAIC,  row.names = FALSE,
          file = "Willamette_Chin_BH_flow_models_mainstem_model_selection_all.csv")
...
```{r tbl_summary_stats}
tbl_smry <- mod_fit$BUGSoutput$summary[c("alpha","E_BH_a","beta","c1"),
