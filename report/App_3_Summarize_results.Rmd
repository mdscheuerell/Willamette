...
plot(t_idx_f, run_size[3,], ylim = c(yp_min,yp_max), type = "n",
     ...
     xlab = "Year", ylab = expression(Catch~+~Escapement~(10^3)),
     main = "", cex.lab = 1.2)
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/Fig_4_covar_effects}
\end{center}
...
png(file.path(figsdir, "Fig_5_proc_errs.png"),
     height = 4, width = 7, units = "in", res = 500)
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/Fig_5_proc_errs}
\end{center}
