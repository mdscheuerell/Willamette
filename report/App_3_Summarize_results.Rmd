...
```{r plot_cov_effects, fig.width=7, fig.height=4, fig.pos="placeHere", warnings=FALSE, messages=FALSE, fig.align="center"}
clr <- rgb(0, 0, 255, alpha = 50, maxColorValue = 255)
xoffSet <- 0.05
yoffSet <- 0.03
...
`r fig_cap(cnt, caption = "Time series of the maximum of the 7-day mean flow during the month of April (a), and its estimated effect on population productivity (b). Small arrows under histograms denote 2.5$^\\text{th}$, 50$^\\text{th}$, and 97.5$^\\text{th}$ percentiles of the posterior distribution.", display = "full")`
