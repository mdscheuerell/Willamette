...
Now we can fit the models. Please note that the following code takes ~3 min to run on a quad-core machine with 3.5 GHz Intel processors.
...
```{r JAGS_IO, message=FALSE, warning=FALSE}
...
```{r model_diagnostics}
mod_fit <- readRDS(file.path(jagsdir, paste0("jags_mod_fit_cov_", best_idx, ".rds")))
